...
(function(){
	...
	// 		disemvowel("this is lower-case").should.equal("ths s lwr-cs");
	// 	});
	// 	it("should remove all vowels from upper-case strings", function() {
	// 		disemvowel("THIS IS UPPER-CASE").should.equal("THS S PPR-CS");
	// 	});
